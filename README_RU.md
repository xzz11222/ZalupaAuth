...
Проект распространяется по кастомной `SessionAuth Custom Non-Sale License`:

- плагин можно использовать на донат-серверах;
- продавать сам плагин, его исходники или готовые сборки нельзя;
- модифицированные версии можно распространять бесплатно с сохранением лицензии и указанием изменений.
